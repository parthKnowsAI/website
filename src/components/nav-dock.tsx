...
const DATA = {
  ...
  contact: {
    social: {
      Tiktok: {
        name: "Tiktok",
        url: "https://www.tiktok.com/@parthknowsai",
        icon: Icons.tiktok,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/parth-patel-093652181/",
        icon: Icons.linkedin,
      },
      YouTube: {
        name: "YouTube",
        url: "https://www.youtube.com/@parthknowsai",
        icon: Icons.youtube,
      },
      Instagram: {
        name: "Instagram",
        url: "https://www.instagram.com/parthknowsai/",
        icon: Icons.instagram,
      },
      email: {
        name: "Send Email",
        url: "mailto:parthknowsai@gmail.com",
        icon: Icons.email,
      },
    },
  },
  ...
  return (
    <div className="flex flex-col items-center justify-center relative z-[9999]">
      <TooltipProvider>
        <Dock
          direction="middle"
          className="bg-neutral-900 backdrop-blur-md rounded-full border border-white/10 shadow-2xl p-2"
        >
