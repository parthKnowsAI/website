...
export function BCMASReviewsFooter({
  ...
  return (
    <div className="bg-neutral-900/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/10">
      <p className="text-white/90 text-sm leading-relaxed mb-4">
        {description}
      </p>
      <div className="flex items-center gap-3">
        {/* Star Icon */}
        {/* <div className="w-10 h-10 rounded-full bg-neutral-800/80 flex items-center justify-center text-yellow-400">
