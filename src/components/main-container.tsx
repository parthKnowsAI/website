                  ...
                  <div className="space-y-6 max-w-lg">
                    ...
                    {showButton && (
                      <Link href={buttonLink}>
                        <button className="group flex items-center gap-2 px-6 py-3 rounded-full border border-white/30 text-white font-medium text-sm hover:bg-white/5 hover:border-white/50 transition-all duration-200 mt-6">
                          {buttonText}
                          <ChevronRight
                            size={16}
